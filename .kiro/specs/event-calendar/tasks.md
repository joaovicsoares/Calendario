...
- [x] 3. Implementar EventRepository (camada de persistência)
  - [x] 3.1 Criar interface IEventRepository
    - Definir métodos Save, Load, Add, Remove
    - _Requirements: 5.1, 5.2_
  
  - [x] 3.2 Implementar EventRepository com serialização JSON
...
- [x] 6. Checkpoint - Verificar lógica de negócio
  - Garantir que todos os testes passam, perguntar ao usuário se há dúvidas.

- [x] 7. Implementar EventNotificationService
  - [x] 7.1 Criar interface IEventNotificationService
    - Definir métodos Start, Stop
    - Definir evento EventDue
    - _Requirements: 4.1, 4.4_
  
  - [x] 7.2 Implementar EventNotificationService
...
- [x] 8. Checkpoint - Verificar serviço de notificação
  - Garantir que todos os testes passam, perguntar ao usuário se há dúvidas.

- [x] 9. Implementar interface do usuário - MainForm
  - [x] 9.1 Criar MainForm com controles básicos
  ...
  - [x] 9.2 Implementar carregamento e exibição de eventos
  ...
  - [x] 9.3 Implementar funcionalidade de remover evento
...
- [x] 10. Implementar interface do usuário - AddEventForm
  - [x] 10.1 Criar AddEventForm (diálogo modal)
    - Adicionar TextBox para descrição
    - Adicionar DateTimePicker para data e hora
    - Adicionar botões "Salvar" e "Cancelar"
    - _Requirements: 1.1, 6.1_
  
  - [x] 10.2 Implementar validação e salvamento
  ...
  - [x] 10.3 Integrar AddEventForm com MainForm
    - Abrir AddEventForm ao clicar em "Adicionar Evento"
    - Atualizar lista de eventos no MainForm após adicionar
    - _Requirements: 1.5_

- [x] 11. Implementar interface do usuário - NotificationModal
  - [x] 11.1 Criar NotificationModal (diálogo modal)
  ...
  - [x] 11.2 Integrar NotificationModal com EventNotificationService
...
- [x] 12. Integração final e inicialização
  - [x] 12.1 Configurar Program.cs
  ...
  - [x] 12.3 Garantir interface responsiva
...
- [-] 13. Checkpoint final - Testes de integração
  ...
  - [x] 13.2 Garantir que todos os testes passam
    - Executar todos os testes unitários
    - Executar todos os testes de propriedade
    - Corrigir quaisquer falhas
  
  - [x] 13.3 Verificação final com o usuário
    - Garantir que todos os testes passam, perguntar ao usuário se há dúvidas.
